    ...
    return (
        <Card
            ...
            <CardContent className="p-6 text-center">
                <p className="text-zinc-500 dark:text-zinc-400 text-sm">累计时间</p>
                <p className="text-3xl font-bold mt-1 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-500">
                    75 分钟
                </p>
            </CardContent>
        </Card>
